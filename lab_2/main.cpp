...
class String
{
 ...
 public:
  ...
  String(const String &str)
  {
    ...
    for (int i = 0; i < _length; i++) _str[i] = str._str[i];
...
class IdentifierString final : public String
{
 ...
 public:
  ...
  IdentifierString(const IdentifierString &other)
  {
    ...
    for (int i = 0; i < _length; i++) _str[i] = other._str[i];
...
class OctalString final : public String
{
 ...
 public:
  ...
  OctalString &operator=(const OctalString &other)
  {
    ...
    for (int i = 0; i < length; i++) _str[i] = other._str[i];
  ...
  void _initStrings(void)
  {
    ...
    while (true)
    {
      ...
      for (size_t i = 0; i < _stringNumber; i++)
      {
        ...
        if (_strArr[i]->getLength() == 0) continue;
      }
      ...
      while (test_readiness)
      {
        ...
        switch (option)
        {
          ...
          case 4:
          {
            ...
            cout << endl;
            cout << "Выберите номер строки, которую вы хотите сделать первым "
                    "операндом"
                 << endl;
            ...
            operand_1->printLine();
            cout << "'" << endl << endl;
            cout << "Выберите номер строки, которую вы хотите сделать вторым "
                    "операндом"
                 << endl;
